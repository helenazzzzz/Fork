...
if(isset($_POST['delete'])){
    $DeleteQuery = "DELETE recipes, users_uploads, users_favorites, ingredients, instructions
                    FROM recipes
                    LEFT JOIN users_uploads ON users_uploads.recipe_id = recipes.recipe_id
                    LEFT JOIN users_favorites ON users_favorites.recipe_id = recipes.recipe_id
                    LEFT JOIN ingredients ON ingredients.recipe_id = recipes.recipe_id
                    LEFT JOIN instructions ON instructions.recipe_id = recipes.recipe_id
                    WHERE recipes.recipe_id= '$_POST[delete]'";          
    mysqli_query($link, $DeleteQuery);
    if(!mysqli_query){
...
<html>
    ...
    <body>
        <div id="hamburger">
            ...
            <a href="user_uploads.1.php">my uploads</a>
