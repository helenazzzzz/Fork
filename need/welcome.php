...
while($record = mysqli_fetch_array($myData)){
    if ($record['recipe_category'] == 'cake') {
        $cakedata = $cakedata . "<div class='rec'>
        ...
        $cookiedata = $cookiedata . "<div class='rec'>
        <button type=submit name=view value='" . $record['recipe_id'] . "'>
        <div class='img__wrap'>
        <img src= 'images/" . $record['recipe_image'] . "' alt='An image of " . $record['recipe_name'] . "'>
        <div class='img__description_layer'>
        ...
        $pastrydata = $pastrydata . "<div class='rec'>
        <button type=submit name=view value='" . $record['recipe_id'] . "'>
        <div class='img__wrap'>
        <img src= 'images/" . $record['recipe_image'] . "' alt='An image of " . $record['recipe_name'] . "'>
        <div class='img__description_layer'>
        ...
        $frozendata = $frozendata . "<div class='rec'>
        <button type=submit name=view value='" . $record['recipe_id'] . "'>
        <div class='img__wrap'>
        <img src= 'images/" . $record['recipe_image'] . "' alt='An image of " . $record['recipe_name'] . "'>
        <div class='img__description_layer'>
