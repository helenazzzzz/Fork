...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Check if username is empty and provide feedback
    ...
    // Check if password is empty and provide feedback
...
<body>
    <div class="wrapper">
        <!--Login form checks input boxes are complete-->
        <h2>Login</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="password" name="password" class="form-control txtbox">
